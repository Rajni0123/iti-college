...
export default function CollectScreen() {
  ...
  const handleThermalPrint = async (fee) => {
    ...
    try {
      const thermalData = {
        receipt_number: fee.receipt_number || fee.invoice_number,
                ...
                <View key={fee.id} style={styles.recentCard}>
                  ...
                  <View style={styles.recentActions}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => handleThermalPrint(fee)}
                    >
                      <MaterialCommunityIcons name="printer-pos" size={14} color="#7c3aed" />
                      <Text style={styles.thermalBtnText}>Thermal</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
